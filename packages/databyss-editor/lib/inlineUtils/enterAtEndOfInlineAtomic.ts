...
export const enterAtEndOfInlineAtomic = ({
  ...
  if (
    ...
    // if (editor.selection.focus.offset < currentLeaf.text.length) {
    console.log('[enter]', editor.children[editor.selection!.focus.path[0]])
    ...
    requestAnimationFrame(() => {
      ...
      //   reverse: true,
      // })
      // Transforms.insertText(editor, 'pp')

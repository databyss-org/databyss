...
describe('editor selenium', () => {
  beforeEach(async done => {
    driver = await startSession('Slate-5-editor-format-win-chrome', WIN, CHROME)
  ...
  it('should toggle bold and insert text', async () => {
    await sleep(300)
    await editor.sendKeys('this text is plain. ')
    // toggle bold

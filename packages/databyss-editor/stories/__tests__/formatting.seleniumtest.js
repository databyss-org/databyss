...
describe('format text in editor', () => {
  ...
  it(
    'toggle bold in entry using hotkeys',
    withRetry(async () => {
      await sleep(300)
  ...
  it(
    'should toggle italic in entry using hotkeys',
    withRetry(async () => {
      await sleep(300)
      await actions.sendKeys('following text should be ')
  ...
  it(
    'should toggle location in entry using hotkeys',
    withRetry(async () => {
      await sleep(300)
      await actions.sendKeys('following text should be ')
  ...
  it(
    'should toggle location bold and italic in entry using hotkeys',
    withRetry(async () => {
      await sleep(300)
      await actions.sendKeys('following text should be ')
      await toggleBold(actions)
  ...
  it(
    'should toggle bold using the format toolbar',
    withRetry(async () => {
      await sleep(300)
  ...
  it(
    'should toggle italic using the format toolbar',
    withRetry(async () => {
      await sleep(300)
  ...
  it(
    'should toggle location using the format toolbar',
    withRetry(async () => {
      await sleep(300)
  ...
  it(
    'should toggle a bold and italic within a source',
    withRetry(async () => {
      await sleep(300)
  ...
  it(
    'should not allow locations on sources, allow italic and bold',
    withRetry(async () => {
      await sleep(300)
